...
class ServerLogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('karyawan.server.index', compact(
            'serverLog',
            'totalLog',
            'statusNormal',
            'statusWarning',
    ...
    {
        return view('karyawan.server.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        // Log aktivitas - DATA INI AKAN MUNCUL DI DASHBOARD ADMIN
        LogAktivitas::create([
            'user_id' => auth()->id(),
        ...
        return redirect()->route('karyawan.serverlog.index')
            ->with('success', 'Log server berhasil ditambahkan');
    }

    // Tampilkan detail log server
    public function show($id)
    {
        $serverLog = ServerLog::findOrFail($id);
        return view('karyawan.server.show', compact('serverLog'));
    }
    ...
    {
        $serverLog = ServerLog::findOrFail($id);
        return view('karyawan.server.edit', compact('serverLog'));
    }
