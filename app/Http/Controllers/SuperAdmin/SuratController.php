...
class SuratController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('superadmin.surat.index', compact('surat', 'totalSurat', 'suratMasuk', 'suratKeluar'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superadmin.surat.index')
    ...
    public function show($id)
    {
        ...
        return view('superadmin.surat.show', compact('surat'));
    }
    ...
    {
        $surat = Surat::findOrFail($id);
        return view('superadmin.surat.edit', compact('surat'));
    }
