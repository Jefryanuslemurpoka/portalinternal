...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-4 sm:mb-6">
        <a href="{{ route('karyawan.surat.index') }}" class="inline-flex items-center text-gray-600 hover:text-gray-800 text-sm sm:text-base">
    ...
    <div class="bg-white rounded-lg sm:rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-teal-500 to-cyan-600 px-4 sm:px-6 py-3 sm:py-4">
            <h3 class="text-lg sm:text-xl font-bold text-white">Form Edit Surat</h3>
        </div>

        <!-- Form -->
        <form action="{{ route('karyawan.surat.update', $surat->id) }}" method="POST" enctype="multipart/form-data" class="p-4 sm:p-6">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="file-upload">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-xs sm:text-sm text-gray-600 mb-1">Klik untuk upload file baru</p>
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-3 mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
                <a href="{{ route('karyawan.surat.index') }}" class="btn btn-secondary text-sm sm:text-base order-2 sm:order-1">
