...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6">
        <form method="GET" action="{{ route('karyawan.serverlog.index') }}" class="space-y-4">
    ...
    <div class="bg-white rounded-lg sm:rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 p-4 sm:p-6 border-b border-gray-200">
            ...
            <a href="{{ route('karyawan.serverlog.create') }}" 
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 lg:px-6 py-4">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('karyawan.serverlog.edit', $log->id) }}" 
...
<script>
    ...
    function resetFilter() {
        window.location.href = "{{ route('karyawan.serverlog.index') }}";
    }
    ...
    function openDeleteModal(id, aktivitas) {
        ...
        document.getElementById('deleteForm').action = `/karyawan/server-log/${id}`;
