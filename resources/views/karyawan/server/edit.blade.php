...
<div class="max-w-3xl mx-auto">
    ...
    <!-- Back Button -->
    <div class="mb-6">
        <a href="{{ route('karyawan.serverlog.index') }}" class="inline-flex items-center text-gray-600 hover:text-gray-800">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <!-- Form -->
        <form action="{{ route('karyawan.serverlog.update', $serverLog->id) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-end space-x-3 mt-8 pt-6 border-t border-gray-200">
                <a href="{{ route('karyawan.serverlog.index') }}" class="btn btn-secondary">
