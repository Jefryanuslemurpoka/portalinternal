...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <h2 class="text-2xl font-bold text-gray-800">Tambah Pemasukan Baru</h2>
            <p class="text-gray-600 text-sm">Lengkapi form untuk menambahkan data pemasukan</p>
        </div>
    ...
    <form id="formPemasukan" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="invoice_number" value="INV-IN-2024-0244" readonly
                    ...
                    <p class="text-xs text-gray-500 mt-1">Nomor otomatis generate</p>
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="so_number" placeholder="Contoh: SO-2024-0190"
                ...
                <div>
                    ...
                    <input type="date" id="tanggal" value="2024-12-17"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="time" id="waktu" value="14:30"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="pelanggan" placeholder="Contoh: PT Mitra Sejahtera" required
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="kontak" placeholder="Contoh: 0821-9876-5432"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="mt-4 text-center text-gray-500" id="emptyState">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="deskripsi" placeholder="Contoh: Penjualan Produk Premium" required
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                </div>
...
document.getElementById('formPemasukan').addEventListener('submit', function(e) {
    ...
    // Simulasi submit
    if (confirm('Simpan data pemasukan ini?')) {
