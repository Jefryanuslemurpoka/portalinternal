...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <h2 class="text-2xl font-bold text-gray-800">Tambah Anggaran Baru</h2>
            <p class="text-gray-600 text-sm">Lengkapi form untuk menambahkan anggaran</p>
        </div>
        <div class="bg-teal-100 p-4 rounded-xl">
            <i class="fas fa-plus-circle text-4xl text-teal-600"></i>
        </div>
    </div>
    ...
    <form id="formAnggaran" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="kategori" required onchange="updateIcon()"
                        ...
                        <option value="operasional" data-icon="cog" data-color="blue">Operasional</option>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="deskripsi_singkat" placeholder="Contoh: Biaya operasional harian" required
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="total_anggaran" value="0" min="0" required onchange="hitungDistribusi()"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" id="persentase" value="0" min="0" max="100" step="0.1" readonly
            ...
            <div class="mt-6 p-4 bg-gradient-to-br from-teal-50 to-green-50 rounded-lg border border-teal-200">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                    <div class="bg-white p-3 rounded-lg">
                        ...
                        <p class="font-bold text-teal-600" id="dist-jan">Rp 0</p>
                    </div>
                    <div class="bg-white p-3 rounded-lg">
                        <p class="text-xs text-gray-600">Februari</p>
                        <p class="font-bold text-teal-600" id="dist-feb">Rp 0</p>
                    </div>
                    <div class="bg-white p-3 rounded-lg">
                        <p class="text-xs text-gray-600">Maret</p>
                        <p class="font-bold text-teal-600" id="dist-mar">Rp 0</p>
                    </div>
                    <div class="bg-white p-3 rounded-lg">
                        <p class="text-xs text-gray-600">April</p>
                        <p class="font-bold text-teal-600" id="dist-apr">Rp 0</p>
                    </div>
                    <div class="bg-white p-3 rounded-lg">
                        <p class="text-xs text-gray-600">Mei</p>
                        <p class="font-bold text-teal-600" id="dist-mei">Rp 0</p>
                    </div>
                    <div class="bg-white p-3 rounded-lg">
                        <p class="text-xs text-gray-600">Juni</p>
                        <p class="font-bold text-teal-600" id="dist-jun">Rp 0</p>
                    </div>
                    <div class="bg-white p-3 rounded-lg">
                        <p class="text-xs text-gray-600">Juli</p>
                        <p class="font-bold text-teal-600" id="dist-jul">Rp 0</p>
                    </div>
                    <div class="bg-white p-3 rounded-lg">
                        <p class="text-xs text-gray-600">Agustus</p>
                        <p class="font-bold text-teal-600" id="dist-agu">Rp 0</p>
                    </div>
                    <div class="bg-white p-3 rounded-lg">
                        <p class="text-xs text-gray-600">September</p>
                        <p class="font-bold text-teal-600" id="dist-sep">Rp 0</p>
                    </div>
                    <div class="bg-white p-3 rounded-lg">
                        <p class="text-xs text-gray-600">Oktober</p>
                        <p class="font-bold text-teal-600" id="dist-okt">Rp 0</p>
                    </div>
                    <div class="bg-white p-3 rounded-lg">
                        <p class="text-xs text-gray-600">November</p>
                        <p class="font-bold text-teal-600" id="dist-nov">Rp 0</p>
                    </div>
                    <div class="bg-white p-3 rounded-lg">
                        <p class="text-xs text-gray-600">Desember</p>
                        <p class="font-bold text-teal-600" id="dist-des">Rp 0</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div id="subKategoriList" class="space-y-3">
                <!-- Sub kategori akan ditambahkan di sini -->
            </div>

            <div class="mt-4 text-center text-gray-500" id="emptySubKategori">
        ...
        <div class="bg-gradient-to-br from-teal-600 to-teal-600 rounded-xl shadow-lg p-6 text-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div class="bg-teal bg-opacity-20 rounded-lg p-4">
                    ...
                    <p class="text-2xl font-bold" id="summary-total">Rp 0</p>
                </div>
                <div class="bg-teal bg-opacity-20 rounded-lg p-4">
                    <p class="text-teal-100 text-sm mb-1">Per Bulan (Rata-rata)</p>
                    <p class="text-2xl font-bold" id="summary-perbulan">Rp 0</p>
                </div>
                <div class="bg-teal bg-opacity-20 rounded-lg p-4">
                ...
                <div class="bg-teal bg-opacity-20 rounded-lg p-4">
                    ...
                    <p class="text-2xl font-bold" id="summary-status">Draft</p>
                </div>
            </div>
        </div>
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-3">
                    ...
                    <button type="submit" class="bg-teal-600 hover:bg-teal-700 text-white px-8 py-3 rounded-lg font-semibold shadow-lg transition">
                        <i class="fas fa-check mr-2"></i>Simpan Anggaran
                    </button>
                </div>
            </div>
        </div>
...
document.getElementById('formAnggaran').addEventListener('submit', function(e) {
    ...
    // Simulasi submit
    if (confirm('Simpan data anggaran ini?')) {
