...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl shadow-lg p-6 text-white">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white/20 backdrop-blur-sm rounded-xl p-4">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-white/80">Total Pemasukan</span>
            ...
            <div class="bg-white/20 backdrop-blur-sm rounded-xl p-4">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-white/80">Total Pengeluaran</span>
            ...
            <div class="bg-white/20 backdrop-blur-sm rounded-xl p-4">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-white/80">Saldo</span>
            ...
            <div class="bg-white/20 backdrop-blur-sm rounded-xl p-4">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-white/80">Invoice Pending</span>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <a href="{{ route('karyawan.absensi.index') }}" class="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition text-center">
            ...
            <p class="font-semibold text-gray-900 text-sm">Absensi</p>
        </a>

        <a href="{{ route('finance.gaji.index') }}" class="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition text-center">
            <div class="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <i class="fas fa-wallet text-emerald-600 text-xl"></i>
            </div>
            <p class="font-semibold text-gray-900 text-sm">Gaji</p>
        </a>

        <a href="{{ route('finance.pengeluaran.index') }}" class="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition text-center">
            <div class="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <i class="fas fa-arrow-down text-red-600 text-xl"></i>
            </div>
            <p class="font-semibold text-gray-900 text-sm">Pengeluaran</p>
        </a>

        <a href="{{ route('finance.pemasukan.index') }}" class="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition text-center">
            <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <i class="fas fa-arrow-up text-green-600 text-xl"></i>
            </div>
            <p class="font-semibold text-gray-900 text-sm">Pemasukan</p>
        </a>

        <a href="{{ route('finance.laporan.index') }}" class="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition text-center">
            <div class="w-12 h-12 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <i class="fas fa-file-invoice-dollar text-cyan-600 text-xl"></i>
            </div>
