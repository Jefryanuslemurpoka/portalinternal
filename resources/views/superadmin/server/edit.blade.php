...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <!-- Back Button -->
    <div class="mb-6">
        <a href="{{ route('superadmin.serverlog.index') }}" class="inline-flex items-center text-gray-600 hover:text-teal-600 transition font-medium">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-teal-600 to-cyan-600 px-8 py-6">
            <h3 class="text-xl font-bold text-white flex items-center">
                ...
                Form Edit Log Server
            </h3>
            <p class="text-sm text-white/90 mt-2">Perbarui informasi log server dengan detail yang benar</p>
        </div>

        <!-- Form -->
        <form action="{{ route('superadmin.serverlog.update', $serverLog->id) }}" method="POST" class="p-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-4 pt-2 mt-6">
                        <a href="{{ route('superadmin.serverlog.index') }}" class="block w-full px-6 py-4 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold rounded-xl transition text-center">
