    ...
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl shadow-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-indigo-100">Generate dan export laporan absensi, cuti/izin, dan karyawan</p>
            </div>
            ...
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-blue-100">Rekap kehadiran karyawan</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-purple-500 to-purple-600 px-6 py-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-purple-100">Rekap pengajuan cuti & izin</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-green-500 to-green-600 px-6 py-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-green-100">Data master karyawan</p>
                    </div>
                </div>
            </div>
