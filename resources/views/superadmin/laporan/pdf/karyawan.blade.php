    ...
    <div class="summary-section">
        <table>
            <tr>
                ...
                <td class="summary-value">{{ $karyawan->count() }} karyawan</td>
                <td class="summary-label">Aktif:</td>
                <td class="summary-value">{{ $karyawan->where('status', 'aktif')->count() }}</td>
            </tr>
            <tr>
                <td class="summary-label">Non-Aktif:</td>
                <td class="summary-value">{{ $karyawan->where('status', 'nonaktif')->count() }}</td>
                <td class="summary-label">Total Divisi:</td>
                <td class="summary-value">{{ $karyawan->pluck('divisi')->unique()->count() }}</td>
            </tr>
        </table>
    </div>
        ...
        <tbody>
            @forelse($karyawan as $key => $item)
                <tr>
                    ...
                    <td class="text-center name-cell">{{ $item->nik ?? '-' }}</td>
