...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6">
        <form method="GET" action="{{ route('superadmin.surat.index') }}" class="space-y-4">
            ...
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <a href="{{ route('superadmin.surat.index') }}" class="text-xs sm:text-sm text-gray-600 hover:text-gray-800">
    ...
    <div class="bg-white rounded-lg sm:rounded-xl shadow-lg overflow-hidden">
        <div class="p-4 sm:p-6 border-b border-gray-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
            ...
            <a href="{{ route('superadmin.surat.create') }}" class="w-full sm:w-auto inline-flex items-center justify-center px-4 sm:px-5 py-2 sm:py-2.5 bg-gradient-to-r from-teal-500 to-cyan-600 text-white font-semibold rounded-lg hover:from-teal-600 hover:to-cyan-700 transition shadow-md text-sm whitespace-nowrap">
