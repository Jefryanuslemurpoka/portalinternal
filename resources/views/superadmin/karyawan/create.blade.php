            ...
            <div class="space-y-6">
                ...
                <div>
                    <label for="password" class="form-label">
                        <i class="fas fa-lock mr-2 text-teal-600"></i>Password <span class="text-red-500">*</span>
                    </label>
                    <div class="relative">
                ...
                <div>
                    <label for="password_confirmation" class="form-label">
                        <i class="fas fa-lock mr-2 text-teal-600"></i>Konfirmasi Password <span class="text-red-500">*</span>
                    </label>
