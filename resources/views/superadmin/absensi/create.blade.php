...
<div class="max-w-4xl mx-auto space-y-4 sm:space-y-6">
    ...
    <div class="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-teal-500 to-cyan-600 px-4 sm:px-6 py-4 sm:py-5">
            ...
            <p class="text-xs sm:text-sm text-white/80 mt-1">Isi form di bawah untuk menambah data absensi karyawan</p>
        </div>
        ...
        <!-- Form -->
        <form action="{{ route('superadmin.absensi.store') }}" method="POST" enctype="multipart/form-data" class="p-4 sm:p-6 space-y-4 sm:space-y-6">
            @csrf
