...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-teal-500 to-cyan-600 px-8 py-6">
            ...
            <p class="text-sm text-white/90 mt-2">Edit data absensi {{ $absensi->user->name }}</p>
        </div>
        ...
        <!-- Form -->
        <form action="{{ route('superadmin.absensi.update', $absensi->id) }}" method="POST" enctype="multipart/form-data" class="p-8">
            @csrf
            @method('PUT')
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="keterangan" id="keterangan" rows="3" 
                                  class="form-input" 
                                  placeholder="Tambahkan catatan atau keterangan (opsional)">{{ old('keterangan', $absensi->keterangan ?? '') }}</textarea>
                        <p class="text-xs text-gray-500 mt-2">Opsional, berikan keterangan jika diperlukan</p>
                    </div>

                    <!-- Baris 4: Lokasi & Upload Foto -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Lokasi (Koordinat) -->
                        <div>
                            <label class="form-label text-sm font-semibold text-gray-700 mb-2 block">
                    ...
                    <div>
                        ...
                        <div class="relative inline-block">
                            <img src="{{ asset('storage/' . $absensi->foto) }}" alt="Foto Absensi" class="max-w-sm h-auto rounded-xl border-2 border-gray-200 shadow-sm">
                        </div>
                    </div>
                    @endif
                    ...
                    <div id="preview-container" class="hidden">
                        ...
                        <div class="relative inline-block">
                            <img id="preview-image" src="" alt="Preview" class="max-w-sm h-auto rounded-xl border-2 border-gray-200 shadow-sm">
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200 rounded-xl p-6">
                        ...
                        <ul class="space-y-3 text-sm text-gray-700">
                            <li class="flex items-start">
                                <i class="fas fa-check-circle text-amber-600 mt-0.5 mr-3"></i>
                            ...
                            <li class="flex items-start">
                                ...
                                <span class="font-semibold">Foto lama akan terganti jika upload foto baru</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white border-2 border-gray-200 rounded-xl p-6">
                        <h3 class="font-bold text-gray-800 mb-4 flex items-center">
                            <i class="fas fa-user-clock text-teal-600 mr-2"></i>
                            Data Absensi
                        </h3>
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between p-3 bg-gray-50 rounded-lg">
                                <span class="text-gray-600">Karyawan:</span>
                                <span class="font-semibold text-gray-900">{{ $absensi->user->name }}</span>
                            </div>
                            <div class="flex justify-between p-3 bg-gray-50 rounded-lg">
                                <span class="text-gray-600">Divisi:</span>
                                <span class="font-semibold text-gray-900">{{ $absensi->user->divisi }}</span>
                            </div>
                            <div class="flex justify-between p-3 bg-gray-50 rounded-lg">
                                <span class="text-gray-600">Tanggal:</span>
                                <span class="font-semibold text-gray-900">{{ $absensi->tanggal->format('d/m/Y') }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 pt-2">
                        <button type="submit" class="w-full px-6 py-4 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white font-semibold rounded-xl transition shadow-lg hover:shadow-xl">
